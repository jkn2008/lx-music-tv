...
/**
 * 与 takagen99/Box 宿主 com.github.catvod.net.OkHttp 核心方法同签名。
 *
 * 已裁剪 TVBox 特有依赖（Doh/OkGoHelper/okhttp3.dnsoverhttps.DnsOverHttps），
 * 保留真实爬虫代码常用的网络方法（string/newCall/client/toBody/get）。
 * dns() 固定返回 Dns.SYSTEM，不启用 DoH（本 App 未引入 okhttp-dnsoverhttps 模块）。
 */
public class OkHttp {
